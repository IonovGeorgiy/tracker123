package edu.khai.tracker.repository;

import edu.khai.tracker.TrackerApp;
import edu.khai.tracker.config.Constants;
import edu.khai.tracker.config.audit.AuditEventConverter;
import edu.khai.tracker.domain.PersistentAuditEvent;
...
import static edu.khai.tracker.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
